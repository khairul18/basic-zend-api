 ...
 */
class UserActivatedLogHydratorFactory implements FactoryInterface
{
    /**
    ...
    public function __invoke(ContainerInterface $container, $requestedName, array $options = null)
    {
        ...
        $hydrator->addStrategy('userProfile', new Strategy\UserProfileStrategy);
        $hydrator->addStrategy('changedBy', new Strategy\UserProfileStrategy);
