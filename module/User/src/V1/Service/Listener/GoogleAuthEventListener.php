...
class GoogleAuthEventListener implements ListenerAggregateInterface
{
    ...
    public function attach(EventManagerInterface $events, $priority = 1)
    {
        $this->listeners[] = $events->attach(
            GoogleAuthEvent::EVENT_GOOGLE_AUTH,
            [$this, 'saveGoogleAuth'],
            499
        );
    }

    public function saveGoogleAuth(GoogleAuthEvent $event)
    {
