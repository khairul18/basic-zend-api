...
class FacebookAuthEventListenerFactory implements FactoryInterface
{
    public function __invoke(ContainerInterface $container, $requestedName, array $options = null)
    {
        ...
        $facebookAuthEventListener = new FacebookAuthEventListener(
            $oauth2AccessToken,
            $userMapper,
            $userProfileMapper,
            $accessTokensMapper,
        ...
        $facebookAuthEventListener->setLogger($container->get("logger_default"));
        return $facebookAuthEventListener;
    }
}
