...
class GoogleAuthEvent extends Event
{


    const EVENT_GOOGLE_AUTH         = 'save.google.auth';
    const EVENT_GOOGLE_AUTH_SUCCESS = 'save.google.auth.success';
    const EVENT_GOOGLE_AUTH_ERROR   = 'save.google.auth.error';
     ...
     */
    public function getGoogleAuthData()
    {
     ...
     */
    public function setGoogleAuthData(array $googleAuthData)
    {
