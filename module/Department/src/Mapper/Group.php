 ...
 * Group Mapper
 */
class Group extends AbstractMapper implements MapperInterface
{
    /**
    ...
    {
        return $this->getEntityManager()->getRepository('Department\\Entity\\Group');
    }
    ...
    public function fetchAll(array $params, $order = null, $asc = false)
    {
        ...
        // filter by is_active (feature not yet needed)
