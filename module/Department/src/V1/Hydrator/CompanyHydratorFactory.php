<?php
namespace Department\V1\Hydrator;
 ...
 */
class CompanyHydratorFactory implements FactoryInterface
{
    /**
    ...
    public function __invoke(ContainerInterface $container, $requestedName, array $options = null)
    {
        ...
        // $hydrator->addStrategy('path', new \Item\V1\Hydrator\Strategy\PhotoStrategy($url));
        $hydrator->addStrategy('account', new \User\V1\Hydrator\Strategy\AccountObjectStrategy);
        // $hydrator->addStrategy('businessSector', new \User\V1\Hydrator\Strategy\BusinessSectorStrategy);
