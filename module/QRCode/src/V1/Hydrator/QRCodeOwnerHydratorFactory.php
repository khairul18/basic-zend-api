 ...
 */
class QRCodeOwnerHydratorFactory implements FactoryInterface
{
    /**
    ...
    public function __invoke(ContainerInterface $container, $requestedName, array $options = null)
    {
        ...
        // $hydrator->addStrategy('visitorUuid', new \User\V1\Hydrator\Strategy\UserProfileStrategy);
        // $hydrator->addStrategy('qrCodeUuid', new \User\V1\Hydrator\Strategy\UserProfileStrategy);
        $hydrator->addStrategy('userProfileUuid', new \User\V1\Hydrator\Strategy\UserProfileStrategy);
